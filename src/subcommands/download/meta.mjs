...
export default function(cli) {
	cli.subcommand("download", "Downloads & anonymises Twitter data from the Academic API (not guaranteed to be downloaded in chronological order)")
		...
		.argument("tweets-per-request", "Max number of tweets to ask for per api call. Default: 500, can range from 10 to 500. Keep at a low value during testing, then bump it to max for the actual run.", 500, "integer")
